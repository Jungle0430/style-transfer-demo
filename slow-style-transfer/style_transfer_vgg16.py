'''
Environment:python-3.6.13  tensorflow-2.0.0  keras-2.3.1  scipy-1.5.2  pillow-8.3.1
Terminal Shell: python style_transfer_vgg16.py content/<content image> style/<style image> result/output_x
'''
...
# style_reference_image_path = 'style/2.jpg'
